                ...
                Column {
                    ...
                    Row {
                        ...
                        TextField {
                            ...
                            text: Julia.get_data(["Training","Design","height"])
                            width: 140*pix
                    ...
                    Row {
                        ...
                        TextField {
                            ...
                            property bool need_update: false
                            property double value: 0
                            text: Julia.get_data(["Training","Design","width"])
                            width: 140*pix
                ...
                Column {
                    ...
                    Row {
                        ...
                        TextField {
                            ...
                            property bool need_update: false
                            property double value: 0
                            text: Julia.get_data(["Training","Design","min_dist_x"])
                            width: 140*pix
                    ...
                    Row {
                        ...
                        TextField {
                            ...
                            property bool need_update: false
                            property double value: 0
                            text: Julia.get_data(["Training","Design","min_dist_y"])
                            width: 140*pix
                            validator: RegExpValidator { regExp: /([1-9]\d{0,2})|0/ }
                            onEditingFinished: {
                                value = parseFloat(text)
